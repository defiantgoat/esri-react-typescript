...
export const heatmap = ({field, colorStops, minDensity, maxDensity, radius}: {field: string, colorStops: any[], minDensity?: number, maxDensity?: number, radius?: number}) => ({
  type: "heatmap",
  field,
  colorStops,
...
export const cimPlayground = ({fill}: {fill?: RGBAColor}): any => ({
      ...
      minScale: 990000, // only allow the symbol to be shown at certain scales
      maxScale: 100,
      symbol: {
        "type": "CIMPointSymbol",
        "symbolLayers": [
